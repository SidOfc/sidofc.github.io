...
})(["appearance:none;line-height:1.3;font-size:0.9rem;font-family:", ";padding:", " ", ";", ";border-radius:2px;height:auto;border:1px solid rgba(0,0,0,0.1);", ";cursor:pointer;transition:all 150ms ease-in-out;&:hover{", ";}"], _config_styles__WEBPACK_IMPORTED_MODULE_4__["page"].fontFamily, _config_styles__WEBPACK_IMPORTED_MODULE_4__["spacing"].regular, _config_styles__WEBPACK_IMPORTED_MODULE_4__["spacing"].large, _config_styles__WEBPACK_IMPORTED_MODULE_4__["colors"].withVar('primary', 'background-color'), _config_styles__WEBPACK_IMPORTED_MODULE_4__["colors"].withVar('white', 'color'), _config_styles__WEBPACK_IMPORTED_MODULE_4__["colors"].withVar('primaryHover', 'background-color'));

/***/ })

})
//# sourceMappingURL=index.js.2395590f591832f57f66.hot-update.js.map