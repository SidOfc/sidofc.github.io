  ...
  if (isObj(obj)) {
    ...
    _babel_runtime_corejs2_core_js_object_assign__WEBPACK_IMPORTED_MODULE_0___default()(obj, {
      withVar: function withVar(name) {
        ...
        var valueFmt = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : function (x) {
          return x;
        };
        property = var2css(property);
        var def = "var(--".concat(parents.concat(var2css(name)).join('-'), ");");
        return "\n                        ".concat(property, ": ").concat(valueFmt(obj[name]), ";\n                        ").concat(property, ": ").concat(def, ";\n                    ");
      },
...
//# sourceMappingURL=recruiters-who-call-during-working-hours.js.278bf60f0b126355d906.hot-update.js.map