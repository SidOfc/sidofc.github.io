webpackHotUpdate("static/development/pages/blog/the-greatnesses-and-gotchas-of-yaml.js",{
  ...
  if (isObj(obj)) {
    ...
    _babel_runtime_corejs2_core_js_object_assign__WEBPACK_IMPORTED_MODULE_0___default()(obj, {
      ...
      fmtVar: function fmtVar(name, fmt) {
        ...
        var rawProp = fmt.includes(/\?{2}/g) ? fmt.replace(/\?{2}/g, obj[name]) : obj[name];
        var cssVarProp = fmt.includes(/\?{2}/g) ? fmt.replace(/\?{2}/g, cssVar) : cssVar;
...
//# sourceMappingURL=the-greatnesses-and-gotchas-of-yaml.js.883be4189d7e8519e4da.hot-update.js.map