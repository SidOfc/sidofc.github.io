  ...
  if (isObj(obj)) {
    ...
    _babel_runtime_corejs2_core_js_object_assign__WEBPACK_IMPORTED_MODULE_0___default()(obj, {
      ...
      fmtVar: function fmtVar(name, fmt) {
        ...
        var rawProp = fmt.includes('??') ? fmt.replace('??', obj[name]) : obj[name];
        var cssVarProp = fmt.includes('??') ? fmt.replace('??', cssVar) : cssVar;
...
//# sourceMappingURL=the-greatnesses-and-gotchas-of-yaml.js.e14c9b9d03e7a5fce92c.hot-update.js.map