...
})(["position:relative;appearance:none;line-height:1.3;font-size:0.9rem;font-family:", ";padding:", " ", ";border-radius:2px;height:auto;", ";border:1px solid rgba(0,0,0,0.1);", ";cursor:pointer;&::before{content:'';display:block;transition:opacity 100ms ease-in;position:absolute;top:0;bottom:0;left:0;right:0;z-index:0;opacity:1;", ";}&:hover &::before{opacity:0.9;}"], _config_styles__WEBPACK_IMPORTED_MODULE_4__["page"].fontFamily, _config_styles__WEBPACK_IMPORTED_MODULE_4__["spacing"].regular, _config_styles__WEBPACK_IMPORTED_MODULE_4__["spacing"].large, _config_styles__WEBPACK_IMPORTED_MODULE_4__["colors"].withVar('white', 'background-color'), _config_styles__WEBPACK_IMPORTED_MODULE_4__["colors"].withVar('white', 'color'), _config_styles__WEBPACK_IMPORTED_MODULE_4__["colors"].withVar('primary', 'background-color'));

/***/ })

})
//# sourceMappingURL=index.js.1beb2bb72185eadb1865.hot-update.js.map